import aiimi_python.ap_elastic as ap_elastic

csv_location = "C:\\Users\\jchandler\\Documents\\Datasets\\Simpsons\\simpsons_characters.csv"

apl = ap_elastic.ApElastic(host='localhost', port='9200')
...
apl.add_property_all_docs(index_name="idx_simpsons_characters_copy2", type="character", property_name="name", property_value="apu_lol")
